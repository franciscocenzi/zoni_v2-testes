...
def intersecao_app(geom_lote):
    ...
    # CORREÇÃO: usar a mesma chave usada no registro da camada (combo_app_nuic)
    ...
    print("=== RESULTADO APP (dentro de intersecao_app) ===")
    print(f"em_app_faixa_nuic: {resultado.em_app_faixa_nuic}")
